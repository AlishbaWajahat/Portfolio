                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <form action="#" method="POST" className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" required rows={6} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"></textarea>
                        </div>
